...
import com.wanwan.annotation.RedisCache;
import com.wanwan.annotation.RedisUpdate;
import com.wanwan.common.Constants;
import com.wanwan.model.entity.*;
import com.wanwan.mapper.ArticleMapper;
import com.wanwan.mapper.CommentMapper;
import com.wanwan.mapper.UserArticleLikeMapper;
import com.wanwan.mapper.UserCommentLikeMapper;
import com.wanwan.model.entity.*;
...
public class ArticleServiceImpl extends ServiceImpl<ArticleMapper, Article> implements IArticleService {
    ...
    @Transactional
    @Override
    public void likeOrDislike(Integer articleId, Long userId, Boolean isLike) {
        if(isLike){
