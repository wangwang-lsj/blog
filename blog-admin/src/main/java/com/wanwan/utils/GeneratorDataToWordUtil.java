...
public class GeneratorDataToWordUtil {
    public static final String driverUrl = "jdbc:mysql://127.0.0.1:3306/db_blog?useUnicode=true&characterEncoding=UTF-8&allowMultiQueries=true&zeroDateTimeBehavior=convertToNull&useSSL=false";
