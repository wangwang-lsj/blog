...
public class TestAop {
    @Pointcut(value = "execution(* com.wanwan.service.impl.UserServiceImpl.login(..))")
    public void loginPointCut() {

    }
    @Pointcut(value = "execution(* com.wanwan.controller.UserController.login(..))")
